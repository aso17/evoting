                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body box-profile">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <a class="btn btn-default btn-block" id="detail-kandidat" data-toggle="modal" data-target="#modal-detail" data-nama-l="<?= $kand['nama_lengkap'] ?>" data-pict="<?= $kand['foto'] ?>" data-tempat-lahir="<?= $kand['tempat_lahir'] ?>" data-tgl-lahir="<?= date('l, d F Y', strtotime($kand['tgl_lahir']))  ?>" data-pekerjaan="<?= $kand['pekerjaan'] ?>" data-pendidikan="<?= $kand['pendidikan_terahir'] ?>" data-pengalaman="<?= $kand['pengalaman'] ?>" data-visi="<?= $kand['visi'] ?>" data-misi="<?= $kand['misi'] ?>">

                                            <i class="fa fa-eye"></i></a>
                                    </div>
                                    <div class="col-lg-9">
                                        <a href="<?= base_url('Pemilihan/Proccess_vote') . '/' . $kand['id_event'] . '/' . $kand['id_kandidat'] ?>" class="btn btn-primary btn-block" type="submit" name="submit"><b>VOTE</b></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img id="gam" class="profile-user-img img-fluid" style="width:200px; height:200px;" src="" alt="User profile picture">
                        </div>
