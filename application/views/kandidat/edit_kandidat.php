...
<div class="col-md-12 pt-3 pl-3">
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Form Ubah Kandidat</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <?= form_open_multipart('') ?>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('nomer_urut') ? 'is-invalid' : '' ?> "
                            name="nomer_urut" autocomplete="off" value="<?= $kandidat->nomer_urut ?>">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('nm_lengkap') ? 'is-invalid' : '' ?> "
                            name="nm_lengkap" autocomplete="off" value="<?= $kandidat->nama_lengkap ?>">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('tempat_lahir') ? 'is-invalid' : '' ?>"
                            name="tempat_lahir" autocomplete="off" value="<?= $kandidat->tempat_lahir ?>">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control <?= form_error('tgl_lahir') ? 'is-invalid' : '' ?>"
                            name="tgl_lahir" value="<?= $kandidat->tgl_lahir ?>">
                        <div class="invalid-feedback">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label>*Alamat </label>
                        <input type="text" class="form-control <?= form_error('alamat') ? 'is-invalid' : '' ?>"
                            name="alamat" autocomplete="off" value="<?= $kandidat->alamat ?>">
                        <div class="invalid-feedback">
                            <?= form_error('alamat') ?>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('pekerjaan') ? 'is-invalid' : '' ?>"
                            name="pekerjaan" autocomplete="off" value="<?= $kandidat->pekerjaan ?>">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('pendidikan') ? 'is-invalid' : '' ?>"
                            name="pendidikan" autocomplete="off" value="<?= $kandidat->pendidikan_terahir ?>">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control  <?= form_error('event') ? 'is-invalid' : '' ?> " name="event">
                            ...
                            foreach ($event as $ev) : ?>
                            <?php if ($ev['id_event'] == $kandidat->id_event) : ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('pengalaman') ? 'is-invalid' : '' ?>"
                            name="pengalaman" autocomplete="off" value="<?= $kandidat->pengalaman ?>">
                        <div class="invalid-feedback">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group ">
                        ...
                        <textarea class="form-control <?= form_error('visi') ? 'is-invalid' : '' ?>" rows="4"
                            name="visi" value="<?= $kandidat->visi ?>"></textarea>
                        <div class="invalid-feedback">
                            <?= form_error('visi') ?>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control <?= form_error('misi') ? 'is-invalid' : '' ?>" rows="4"
                            name="misi" autocomplete="off" value="<?= $kandidat->misi ?>"></textarea>
                        <div class="invalid-feedback">
                            <?= form_error('misi') ?>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <img src="<?= base_url('asset/images/kandidat/') . $kandidat->foto ?>" alt=""
                            style="width: 100px;height:100px"
                            class="mb-2 img-fluid img-thumbnail rounded mx-auto d-block">

                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="exampleInputFile" name="foto"
                                    value="<?= $kandidat->foto ?>">
                                <label class="custom-file-label" for="exampleInputFile">Ganti</label>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group ">
                        ...
                        <input class="form-control  <?= form_error('keterangan') ? 'is-invalid' : '' ?> "
                            name="keterangan" value="<?= $kandidat->keterangan ?>">
