                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 d-flex py-3">
                                            <img class="profile-user-img img-fluid img-circle" style="width: 200px;"
                                                src="<?= base_url().'/asset/images/foto_user/'.$users['image']; ?>" alt="User profile picture">
                                        </div>
                                        <div class="col-lg-9">
                                            <ul class="list-group list-group-unbordered mb-3">
                                                <li class="list-group-item">
                                                    <b>Nama</b> <a class="float-right"><?= $this->session->userdata('nama_lengkap')?></a>
                                                </li>
                                                <li class="list-group-item">
                            ...
                            <div class="card card-default card-outline mb-4">
                                <div class="card-body box-profile">
                                    <ul class="list-group list-group-unbordered mb-3">
                                        ...
                                        <li class="list-group-item">
                                            <b>Tempat/Tgl Lahir</b> <a class="float-right"><?= $users['tempat_lahir'].'/'.$users['tgl_lahir'];?></a>
                                        </li>
                                        <li class="list-group-item">
